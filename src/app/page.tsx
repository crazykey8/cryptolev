...
export default function Home() {
  return (
    <main className="h-screen bg-gradient-to-br from-gray-900 via-blue-900/50 to-gray-900 relative overflow-hidden">
      ...
      <div className="h-full container mx-auto px-4 relative">
        <div className="h-full flex items-center justify-center">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 xl:gap-16 w-full max-w-7xl mx-auto">
            {/* Left Content */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6 }}
              className="flex-1 w-full lg:max-w-2xl text-center lg:text-left space-y-6"
            >
              <div className="relative group px-4">
                ...
                <motion.h1
                  className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold relative"
              ...
              <motion.div
                ...
                className="space-y-4"
              >
                <p className="text-xl md:text-2xl lg:text-3xl text-cyan-200 font-medium leading-tight">
            ...
            <motion.div
              ...
              className="flex-1 relative group hidden lg:block"
            >
              <div className="w-64 h-64 xl:w-[350px] xl:h-[350px] relative transition-transform duration-500 transform group-hover:scale-105">
                {/* Glow effect */}
